...
# Function to change wallpaper dir and set the wallpaper
change_wallpaper_theme() {
    ...
    # Get random wallpaper from that directory
    #local wallpaper=$(find "$theme_dir" -type f \( -iname "*.jpg" -o -iname "*.png" -o -iname "*.jpeg" -o -iname "*.gif" \) | shuf -n 1)
